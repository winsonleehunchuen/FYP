...
$result=mysqli_query($con,"select t.test_name,t.total_question,r.test_date,r.score from quiz_test t, quiz_result r where t.test_id=r.test_id and r.loginid='$loginid'") or die(mysqli_error());
